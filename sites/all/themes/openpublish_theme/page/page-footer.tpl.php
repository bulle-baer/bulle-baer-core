...
?>
      ...
      <span class="clear"></span>
        ...
        <div id="footer-links-wrapper">
          ...
          <div id="footer-feed-icon"><a href="<?php print url('rss/articles/all'); ?>"><img src="http://<?php print( $_SERVER['SERVER_NAME']);?>/misc/feed.png" width="16" height="16" alt="<?php print t('Get the main site RSS feed'); ?>"/></a></div>
